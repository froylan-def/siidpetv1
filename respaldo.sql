...
INSERT INTO `ImputadosExpediente` VALUES (23,4),(44,6),(1,10),(29,10),(30,12);
...
CREATE TABLE `acuerdo_sede_ministerial` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `mecanismos_sede_ministerial` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_inicio` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_fin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `conclusion` VALUES (1,'Conclusion1','2024-04-10',1,NULL,NULL),(2,'conclusion del expediente con id 14 EDITADO','2024-12-12',1,'2024-12-12 02:10:06','2024-12-12 02:12:29');
...
INSERT INTO `coordinacion` VALUES (1,'Victoria',1,NULL,NULL),(2,'Mante',1,NULL,NULL),(3,'Reynosa',1,NULL,NULL),(4,'Matamoros',4,NULL,NULL),(5,'Madero',5,NULL,NULL),(6,'Nuevo Laredo',6,NULL,NULL);
/*!40000 ALTER TABLE `coordinacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `coordinacionMunicipio`
--

DROP TABLE IF EXISTS `coordinacionMunicipio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coordinacionMunicipio` (
  `id_coordinacion` bigint unsigned NOT NULL,
  `id_municipio` bigint unsigned NOT NULL,
  PRIMARY KEY (`id_coordinacion`,`id_municipio`),
  KEY `id_municipio` (`id_municipio`),
  CONSTRAINT `coordinacionMunicipio_ibfk_1` FOREIGN KEY (`id_coordinacion`) REFERENCES `coordinacion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `coordinacionMunicipio_ibfk_2` FOREIGN KEY (`id_municipio`) REFERENCES `municipio` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `coordinacionMunicipio`
--

LOCK TABLES `coordinacionMunicipio` WRITE;
/*!40000 ALTER TABLE `coordinacionMunicipio` DISABLE KEYS */;
INSERT INTO `coordinacionMunicipio` VALUES (5,2275),(5,2281),(2,2284),(2,2293),(4,2294),(6,2299),(1,2302),(3,2304),(3,2305),(4,2307),(1,2309),(5,2310),(1,2311),(4,2312),(1,2313),(2,2315),(3,2397);
/*!40000 ALTER TABLE `coordinacionMunicipio` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `defensor` VALUES (1,1,2275,1,NULL,'2025-02-21 02:30:24',5),(2,20,2311,1,'2024-09-28 03:06:17','2025-02-21 02:31:45',1),(3,21,2309,0,'2024-10-03 02:11:23','2025-02-12 02:04:32',1),(4,22,2313,0,'2024-10-03 03:00:53','2025-02-11 23:57:54',1),(8,33,2293,0,'2025-02-06 02:14:41','2025-02-18 01:42:04',2);
...
INSERT INTO `delito` VALUES (11,'ARMAS PROHIBIDAS',1,NULL,NULL),(12,'ASOCIACIÓN DELICTUOSA Y PANDILLERISMO',1,NULL,NULL),(13,'ATENTADOS A LA SEGURIDAD DE LA COMUNIDAD',1,NULL,NULL),(14,'DELITOS CONTRA LA SEGURIDAD DE LOS MEDIOS DE TRANSPORTE, VÍAS DE COMUNICACIÓN, LA LIBRE CIRCULACIÓN DE VEHÍCULOS Y LA CORRESPONDENCIA',1,NULL,NULL),(15,'ATAQUES A LOS MEDIOS DE TRANSPORTE, VÍAS DE COMUNICACIÓN Y SISTEMAS DE AUXILIO A LA POBLACIÓN',1,NULL,NULL),(16,'VIOLACIÓN DE CORRESPONDENCIA',1,NULL,NULL),(17,'SIMULACIÓN DE RETENES OFICIALES',1,NULL,NULL),(18,'DELITOS CONTRA LA AUTORIDAD',1,NULL,NULL),(19,'DESOBEDIENCIA, RESISTENCIA Y COACCIÓN DE PARTICULARES',1,NULL,NULL),(20,'OPOSICIÓN A QUE SE EJECUTE ALGUNA OBRA O TRABAJO PUBLICO',1,NULL,NULL),(21,'QUEBRANTAMIENTO DE SELLOS',1,NULL,NULL),(22,'DELITOS COMETIDOS CONTRA SERVIDORES PÚBLICOS',1,NULL,NULL),(23,'EXPENDIO ILÍCITO DE BEBIDAS ALCOHÓLICAS',1,NULL,NULL),(24,'DELITOS CONTRA LA MORAL PÚBLICA',1,NULL,NULL),(25,'ULTRAJES A LA MORAL PÚBLICA E INCITACIÓN A LA PROSTITUCIÓN',1,NULL,NULL),(26,'CORRUPCIÓN, PORNOGRAFÍA, PROSTITUCIÓN SEXUAL DE MENORES E INCAPACES Y PEDERASTIA',1,NULL,NULL),(27,'LENOCINIO',1,NULL,NULL),(28,'PROVOCACIÓN A UN DELITO Y APOLOGÍA DE ÉSTE O DE ALGÚN VICIO',1,NULL,NULL),(29,'DELITOS CONTRA LA SALUD PÚBLICA',1,NULL,NULL),(30,'PELIGRO DE CONTAGIO',1,NULL,NULL),(31,'DE LA COMERCIALIZACIÓN DEL AGUA',1,NULL,NULL),(32,'DELITOS DE REVELACIÓN DE SECRETOS Y DE ACCESO ILÍCITO A SISTEMAS Y EQUIPOS DE INFORMÁTICA.',1,NULL,NULL),(33,'REVELACIÓN DE SECRETOS',1,NULL,NULL),(34,'ACCESO ILÍCITO A SISTEMAS Y EQUIPOS DE INFORMÁTICA',1,NULL,NULL),(35,'DELITOS POR HECHOS DE CORRUPCIÓN',1,NULL,NULL),(36,'EJERCICIO ILÍCITO DE SERVICIO PÚBLICO',1,NULL,NULL),(37,'ABUSO DE AUTORIDAD',1,NULL,NULL),(38,'COALICIÓN DE SERVIDORES PÚBLICOS',1,NULL,NULL),(39,'COHECHO',1,NULL,NULL),(40,'PECULADO',1,NULL,NULL),(41,'CONCUSIÓN',1,NULL,NULL),(42,'USO ILÍCITO DE ATRIBUCIONES Y FACULTADES',1,NULL,NULL),(43,'INTIMIDACIÓN',1,NULL,NULL),(44,'EJERCICIO ABUSIVO DE FUNCIONES',1,NULL,NULL),(45,'TRAFICO DE INFLUENCIA',1,NULL,NULL),(46,'ENRIQUECIMIENTO ILÍCITO',1,NULL,NULL),(47,'DELITOS COMETIDOS EN EL DESEMPEÑO DE FUNCIONES JUDICIALES O ADMINISTRATIVAS.',1,NULL,NULL),(48,'DESEMPEÑO DE FUNCIONES JUDICIALES O ADMINISTRATIVAS.',1,NULL,NULL),(49,'RESPONSABILIDAD PROFESIONAL',1,NULL,NULL),(50,'RESPONSABILIDAD MÉDICA, TÉCNICA Y ADMINISTRATIVA',1,NULL,NULL),(51,'DELITOS DE ABOGADOS, PATRONOS Y LITIGANTES',1,NULL,NULL),(52,'DELITOS CONTRA LA FE PÚBLICA',1,NULL,NULL),(53,'FALSIFICACIÓN Y CIRCULACIÓN DE TÍTULOS, Y DOCUMENTOS DE CRÉDITO PÚBLICO',1,NULL,NULL),(54,'FALSIFICACIÓN Y USO DE SELLOS, LLAVES, PUNZONES, MATRICES, MARCAS, SEÑALES, PLANCHAS, CONTRASEÑAS Y FIERROS.',1,NULL,NULL),(55,'FALSIFICACIÓN Y USO DE DOCUMENTOS PÚBLICOS O PRIVADOS',1,NULL,NULL),(56,'FALSEDAD EN DECLARACIONES Y EN INFORMES DADOS A UNA AUTORIDAD',1,NULL,NULL),(57,'VARIACIÓN DEL NOMBRE O DEL DOMICILIO',1,NULL,NULL),(58,'USURPACIÓN DE FUNCIONES PÚBLICAS O DE PROFESIÓN',1,NULL,NULL),(59,'USURPACIÓN DE IDENTIDAD',1,NULL,NULL),(60,'USO INDEBIDO DE UNIFORMES, INSIGNIAS DISTINTIVOS O CONDECORACIONES',1,NULL,NULL),(61,'DISPOSICIÓN COMÚN A LOS CAPÍTULOS PRECEDENTES',1,NULL,NULL),(62,'DELITOS CONTRA LA SEGURIDAD Y LIBERTAD SEXUALES',1,NULL,NULL),(63,'ABUSO SEXUAL',1,NULL,NULL),(64,'ESTUPRO',1,NULL,NULL),(65,'VIOLACIÓN',1,NULL,NULL),(66,'HOSTIGAMIENTO Y ACOSO SEXUAL',1,NULL,NULL),(67,'DISPOSICIONES COMUNES A LOS CAPÍTULOS PRECEDENTES',1,NULL,NULL),(68,'DELITOS CONTRA LA FAMILIA Y EL ESTADO CIVIL',1,NULL,NULL),(69,'ALTERACIÓN DEL ESTADO CIVIL.',1,NULL,NULL),(70,'BIGAMIA',1,NULL,NULL),(71,'INCESTO',1,NULL,NULL),(72,'EXPOSICIÓN DE MENORES',1,NULL,NULL),(73,'ABANDONO DE OBLIGACIONES ALIMENTICIAS',1,NULL,NULL),(74,'SUSTRACCIÓN Y RETENCIÓN DE MENORES POR LOS PADRES',1,NULL,NULL),(75,'DELITOS CONTRA LA SALUBRIDAD Y SEGURIDAD EN MATERIA DE INHUMACIONES Y EXHUMACIONES',1,NULL,NULL),(76,'VIOLACIONES DE LAS LEYES SOBRE INHUMACIONES Y EXHUMACIONES',1,NULL,NULL),(77,'DELITOS CONTRA LA PAZ Y SEGURIDAD DE LAS PERSONAS',1,NULL,NULL),(78,'AMENAZAS, DISCRIMINACIÓN Y COBRANZA EXTRAJUDICIAL ILEGAL',1,NULL,NULL),(79,'ALLANAMIENTO DE MORADA',1,NULL,NULL),(80,'ASALTO',1,NULL,NULL),(81,'DELITOS CON MOTIVO DEL TRANSITO DE VEHÍCULOS',1,NULL,NULL),(82,'TRAFICO DE MENORES E INCAPACITADOS',1,NULL,NULL),(83,'DELITOS CONTRA LA VIDA Y LA SALUD DE LAS PERSONAS',1,NULL,NULL),(84,'LESIONES',1,NULL,NULL),(85,'DELITOS CONTRA LOS DERECHOS REPRODUCTIVOS',1,NULL,NULL),(86,'MANIPULACIÓN GENÉTICA',1,NULL,NULL),(87,'HOMICIDIO',1,NULL,NULL),(88,'INDUCCIÓN Y AUXILIO AL SUICIDIO',1,NULL,NULL),(89,'PARRICIDIO',1,NULL,NULL),(90,'FILICIDIO',1,NULL,NULL),(91,'ABORTO',1,NULL,NULL),(92,'ABANDONO DE PERSONAS',1,NULL,NULL),(93,'VIOLENCIA VICARIA CONTRA LA MUJER',1,NULL,NULL),(94,'VIOLENCIA FAMILIAR',1,NULL,NULL),(95,'VIOLENCIA EN LOS ESPECTÁCULOS DEPORTIVOS',1,NULL,NULL),(96,'DELITOS CONTRA EL HONOR',1,NULL,NULL),(97,'GOLPES Y VIOLENCIAS FÍSICAS SIMPLES',1,NULL,NULL),(98,'DELITOS CONTRA LA SEGURIDAD EN EL GOCE DE GARANTÍAS',1,NULL,NULL),(99,'PRIVACIÓN ILEGAL DE LA LIBERTAD Y DE OTRAS GARANTÍAS',1,NULL,NULL),(100,'CIBERACOSO',1,NULL,NULL),(101,'PRIVACIÓN DE LA LIBERTAD CON FINES SEXUALES',1,NULL,NULL),(102,'DELITOS CONTRA EL PATRIMONIO DE LAS PERSONAS',1,NULL,NULL),(103,'ROBO',1,NULL,NULL),(104,'USURA',1,NULL,NULL),(105,'CHANTAJE',1,NULL,NULL),(106,'EXTORSIÓN',1,NULL,NULL),(107,'DESPOJO DE COSAS INMUEBLES O DE AGUAS',1,NULL,NULL),(108,'DAÑO EN PROPIEDAD',1,NULL,NULL),(109,'ENCUBRIMIENTO',1,NULL,NULL),(110,'OPERACIONES CON RECURSOS DE PROCEDENCIA ILÍCITA',1,NULL,NULL),(111,'ENCUBRIMIENTO POR RECEPTACIÓN',1,NULL,NULL),(112,'DE LOS DELITOS COMETIDOS CONTRA EL ORDENAMIENTO TERRITORIAL Y EL DESARROLLO URBANO.',1,NULL,NULL),(113,'DELITOS COMETIDOS POR FRACCIONADORES',1,NULL,NULL),(114,'DELITOS CONTRA EL MEDIO AMBIENTE Y LOS RECURSOS NATURALES',1,NULL,NULL),(115,'DAÑO AL MEDIO AMBIENTE',1,NULL,NULL),(116,'DELITO DE INCENDIOS',1,NULL,NULL),(117,'CONTAMINACIÓN DE AGUAS',1,NULL,NULL),(118,'SUBSTRACCIÓN DEL SUELO',1,NULL,NULL),(119,'PRIVACIÓN DE LA VIDA, MALTRATO O CRUELDAD ANIMAL',1,NULL,NULL);
...
INSERT INTO `entrevista` VALUES (1,4,'2024-04-17','TEST',1,NULL,'2025-01-14 03:28:09'),(14,1,'2025-01-21',NULL,1,'2025-01-21 03:30:04','2025-01-21 03:30:04'),(15,1,'2025-01-13','algo en la entrevista',1,'2025-01-21 03:30:40','2025-01-21 03:30:40');
...
INSERT INTO `estatus_sede_ministerial` VALUES (1,'Estatus de sede',1,NULL,NULL),(2,'CONCLUIDO',1,NULL,NULL),(3,'JUDICIALIZADO',1,NULL,NULL),(4,'LIBERTAD',1,NULL,NULL),(5,'NO EJERCICIO DE LA ACCIÓN PENAL',1,NULL,NULL),(6,'NO VINCULACIÓN',1,NULL,NULL),(7,'REVOCADA DEFENSA PÚBLICA',1,NULL,NULL),(8,'SOBRESEIMIENTO',1,NULL,NULL),(9,'SE REVOCA AUTO DE VINCULACION Y SE DEJA SIN EFECTO LA MEDIDA CAUTELAR',1,NULL,NULL),(10,'TRÁMITE',1,NULL,NULL);
/*!40000 ALTER TABLE `estatus_sede_ministerial` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `examen_detencion`
--

DROP TABLE IF EXISTS `examen_detencion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `examen_detencion` (
...
--
-- Dumping data for table `examen_detencion`
--

LOCK TABLES `examen_detencion` WRITE;
/*!40000 ALTER TABLE `examen_detencion` DISABLE KEYS */;
INSERT INTO `examen_detencion` VALUES ('2024-12-17','04:00','resultado de ejemplo del expediente 14',1,1),('2024-12-18','15:59','asdfasdfasfd',1,2),('2024-12-18','15:59','asdfasdfasfd',1,3),('2024-12-18','10:30','Resultado del exaneb de detenció en el expediente con id 14',1,4),('2024-12-19','22:00','resultado del expediente 14',1,5),('2024-12-19','22:00','resultado del expediente 14',1,6),('2024-12-19','22:00','resultado del expediente 14',1,7),('2024-12-19','02:08','resultado del expediente id 14',1,8);
/*!40000 ALTER TABLE `examen_detencion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `expediente` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `ppl` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_examen_detencion` bigint unsigned DEFAULT NULL,
  ...
  KEY `fk_id_examen_detencion` (`id_examen_detencion`),
  ...
  CONSTRAINT `expediente_id_delito_proceso_foreign` FOREIGN KEY (`id_delito_proceso`) REFERENCES `delito` (`id`),
  ...
  CONSTRAINT `fk_id_examen_detencion` FOREIGN KEY (`id_examen_detencion`) REFERENCES `examen_detencion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `expediente` VALUES (1,'003',4,2,1,'001 / 2025',1,NULL,1,1,'DETERMINACION DEL MP EDITADOOO',1,1,'01/2025','2025-01-15',1,3,'CITA MECANISMOS EJEMPLO',1,'2024-02-01','2020-02-01',NULL,1,1,1,'prueba de edición de la audiencia intermedia',1,1,'JUICIIO EJEMPLO',NULL,'SENTENCIA JUICIIO EJEMPLO',1,'resumen de visita',1,1,1,'2024-04-20 02:03:44','2025-02-18 03:47:44',NULL,NULL,'En proceso',NULL),(23,NULL,4,1,NULL,'003 / 2025',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2025-01-15 00:47:54','2025-02-12 00:26:48',NULL,NULL,'En proceso',NULL),(29,NULL,1,4,NULL,'005 / 2025',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2025-02-11 03:55:01','2025-02-18 03:48:22',NULL,NULL,NULL,NULL),(30,NULL,1,3,NULL,'001 / 2025',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2025-02-12 02:51:11','2025-02-19 01:47:27',NULL,NULL,NULL,NULL),(44,NULL,1,2,NULL,'1297',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2025-02-18 02:44:36','2025-02-18 03:15:55',NULL,NULL,NULL,NULL);
...
INSERT INTO `expediente_delito` VALUES (1,11),(23,12),(44,18);
...
INSERT INTO `flagrancia` VALUES (1,'2024-04-07','15:40',1,NULL,'2024-06-21 01:57:21'),(2,'2024-06-17','04:58',1,'2024-06-19 02:58:57','2024-06-19 02:58:57'),(3,'2024-06-17','04:58',1,'2024-06-19 02:59:04','2024-06-19 02:59:04'),(4,'2024-06-08','16:07',1,'2024-06-19 03:07:53','2024-06-19 03:10:11'),(5,'2024-08-22','13:26',1,'2024-08-23 00:25:58','2024-08-23 00:25:58'),(6,'2024-09-20','14:53',1,'2024-09-12 01:33:30','2024-09-19 03:27:23'),(7,'2024-12-04','11:30',1,'2024-12-04 01:40:53','2024-12-04 01:42:25'),(8,'2025-01-22','14:00',1,'2025-01-30 02:20:31','2025-01-30 02:20:31');
...
INSERT INTO `impugnacion` VALUES (1,'Impugnacion1','2024-01-15',1,NULL,'2025-01-28 23:56:45','observaciones del expediente 001 / 2025'),(2,'impugnacion de expediente no 14 EDITADO 13-DIC','1997-02-12',1,'2024-12-14 03:34:28','2024-12-14 04:11:18','Observaciones de la impugnacion en el expediente 14 EDITADO 13-DIC');
...
INSERT INTO `imputado` VALUES (1,'Jose Alejandro','Segura','Hernandez','(834) 116-32-73','Xyz','masculino',118,28,2313,'soltero/a','1997-02-05',1,1,1,NULL,'2025-01-29 02:02:30'),(4,'Ignacio','Lechuga','Perez','(834) 111-00-11','calle','Masculino',118,28,2313,'Soltero','2025-01-08',1,1,1,'2024-06-06 03:42:21','2025-01-28 03:39:06'),(5,'Pedro','Fernando','Sanchez','(834) 160-98-81','calle x & y','masculino',118,28,2313,'soltero/a','2025-01-22',1,1,1,'2024-06-06 03:58:47','2025-01-28 03:38:31'),(6,'Rodolfo','Damian','Setien','8341609881','calle x colonia y','Masculino',118,2,2274,'Soltero','12-02-1997',1,1,1,'2024-06-06 04:09:24','2025-01-22 22:49:30'),(7,'algo','algo','algo','8341609881','calle','masculino',118,1,1,'soltero/a','2024-09-18',1,1,1,'2024-06-06 04:27:06','2024-09-19 23:49:03'),(8,'Ignación','Rodriguez','Santos','8341609881','calle eucalipto esq durazno','masculino',118,28,2313,'soltero/a','2025-01-22',1,1,1,'2024-06-06 04:29:41','2025-01-23 00:29:11'),(9,'Jose','Martinez','Rodriguez','8341698321','calle a b y c','masculino',118,28,2281,'divorciado/a','1991-02-13',1,1,1,'2024-06-11 03:27:30','2025-01-23 00:28:45'),(10,'Laura Argelia','Perales','Perez','(111) 111-11-11','16 y 18 Berriozabal','femenino',118,28,2313,'divorciado/a','2001-06-04',1,1,1,'2024-06-11 04:04:53','2025-01-28 03:38:49'),(11,'Jose Alejandro','Segura','Hernandez','8321034941','Paseo Bambusa 1730','masculino',118,28,2313,'soltero/a','1998-08-26',1,1,1,'2024-06-14 00:52:49','2024-09-06 03:21:50'),(12,'Ramiro','García','Rojo','(834)160-98-81','x','masculino',118,28,2275,'soltero/a','2024-07-10',1,1,1,'2024-07-11 00:36:10','2025-01-28 01:54:51');
...
INSERT INTO `investigacion_complementaria` VALUES (1,'2024-04-19','12:26:00',1,NULL,NULL),(2,'2024-12-04','2024-12-06',NULL,'2024-12-06 00:09:18','2024-12-06 00:09:18'),(3,'2024-12-04','2024-12-06',NULL,'2024-12-06 00:09:19','2024-12-06 00:09:19'),(4,'2024-12-02','2024-12-03',NULL,'2024-12-06 01:08:07','2024-12-06 02:50:32');
...
INSERT INTO `juez_control` VALUES (1,'Alejandro Segura ss',2280,0,NULL,'2024-10-24 23:43:39'),(2,'Unidad de Tramitación Masiva',2281,0,'2024-05-22 03:31:00','2024-05-22 03:31:00'),(3,'zdfzdf',2282,0,'2024-06-14 03:21:05','2024-06-14 03:21:05'),(4,'zdfzdf',2289,0,'2024-06-14 03:21:19','2024-10-16 04:04:04'),(5,'Unidad de Atención Inmediata',2290,0,'2024-06-27 01:28:45','2024-10-16 04:04:07'),(6,'DALIA INES REYES ZUÑIGA',2313,1,NULL,NULL),(7,'EDWIN VARGAS GUERRERO',2313,1,NULL,NULL),(8,'JOSE ANTONIO RODRIGUEZ GRAJEDA',2313,1,NULL,NULL),(9,'JUAN ARTEMIO HARO MORALES',2313,1,NULL,NULL),(10,'MA. ELVA VILLAGOMEZ ROSALES',2313,1,NULL,NULL),(11,'MARTHA PATRICIA RODRIGUEZ SALINAS',2313,1,NULL,NULL),(12,'PATRICIO LUGO JARAMILLO',2313,1,NULL,NULL),(13,'ROSA MARIA RODULFO ARCEA',2313,1,NULL,NULL),(14,'SANDRA GUADALUPE GARCIA PEREZ',2313,1,NULL,NULL),(15,'SANTIAGO ESPINOZA CAMACHO',2313,1,NULL,NULL),(16,'IGNACIO GARCIA ZUÑIGA',2311,1,NULL,NULL),(17,'AYERIM GUILLEN HERNANDEZ',2302,1,NULL,NULL),(18,'CARLOS FAVIAN VILLALOBOS GONZALEZ',2302,1,NULL,NULL),(19,'JOSE MIGUEL MORENO CASTILLO',2309,1,NULL,NULL),(20,'OMAR ALEJANDRO NAJAR RAMIREZ',2309,1,NULL,NULL),(21,'JOSE GUADALUPE DE LA CRUZ BOCANEGRA',2293,1,NULL,NULL),(22,'KARLA KARINA TREJO TORRES',2293,1,NULL,NULL),(23,'ELISEO SANCHEZ WONG',2315,1,NULL,NULL),(24,'SAMUEL HERNANDEZ SERNA',2315,1,NULL,NULL),(25,'ANA VICTORIA ENRIQUEZ MARTINEZ',2285,1,NULL,NULL),(26,'ARTURO BALTAZAR CALDERON',2294,1,NULL,NULL),(27,'CHRISTIAN OSIRIS HERNANDEZ CORTINA',2294,1,NULL,NULL),(28,'GERARDO RODRIGUEZ VEGA',2294,1,NULL,NULL),(29,'JUAN ANTONIO VALLES MORALES',2294,1,NULL,NULL),(30,'JUAN FIDENCIO RODRIGUEZ SALINAS',2294,1,NULL,NULL),(31,'OSCAR IVAN SEGURA RIVERA',2294,1,NULL,NULL),(32,'ALEJANDRO FEDERICO HERNANDEZ RODRIGUEZ',2307,1,NULL,NULL),(33,'ISAIAS CONTRERAS TAMAYO',2299,1,NULL,NULL),(34,'JOSE LUIS JAIME RODRIGUEZ',2299,1,NULL,NULL),(35,'JOSE LUIS TOBIAS BAZAN',2299,1,NULL,NULL),(36,'MA GUADALUPE BERNAL CASTILLO',2299,1,NULL,NULL),(37,'ALDO RENE ROCHA SANCHEZ',2304,1,NULL,NULL),(38,'ANDRES ESCAMILLA GONZALEZ',2304,1,NULL,NULL),(39,'ARIEL DE LUNA CASADOS',2304,1,NULL,NULL),(40,'JUAN MANUEL HAM CORTES',2304,1,NULL,NULL),(41,'ROSALIA GOMEZ GUERRA',2304,1,NULL,NULL),(42,'VERONICA PATRICIA AVALOS REYES',2304,1,NULL,NULL),(43,'ROSA RAMIREZ ACOSTA',2297,1,NULL,NULL),(44,'RUBEN PADILLA SOLIS',2297,1,NULL,NULL),(45,'CLAUDIA OLIMPIA GAMEZ REY',2305,1,NULL,NULL),(46,'JOSE ARTURO CORDOVA GODINEZ',2275,1,NULL,NULL),(47,'LISSETE LOPEZ MAYET',2275,1,NULL,NULL),(48,'LUZ DEL CARMEN LEE LUNA',2275,1,NULL,NULL),(49,'REYNA KARINA TORRES BARRIENTOS',2275,1,NULL,NULL),(50,'SERGIO ARTURO ARJONA MORENO',2275,1,NULL,NULL),(51,'VICTOR FERNANDO REYES HERNANDEZ',2275,1,NULL,NULL);
...
INSERT INTO `medida_cautelar` VALUES (1,'asdfasdfasdf',0,NULL,'2025-02-12 02:47:08',NULL),(2,'medidas2',1,'2024-10-15 03:49:26','2024-10-15 03:51:11',NULL),(3,'test medida cautelar id 15',NULL,'2024-12-06 03:48:19','2024-12-06 03:48:19','2024-12-06'),(4,'medida cautelar del expediente con identificador numero 14',NULL,'2024-12-06 22:34:00','2024-12-06 22:34:00','2024-12-13');
...
INSERT INTO `orden_aprencion` VALUES (1,'2024-01-01','12:00:00','Observacion1',1,NULL,NULL),(2,'2024-12-17','12:40','observaciones del expediente con id. 14',1,'2024-12-16 22:40:38','2024-12-16 22:40:38'),(3,'2024-12-17','12:40','observaciones del expediente con id. 14',1,'2024-12-16 22:40:42','2024-12-16 22:40:42'),(4,'2024-12-17','15:00','observaciones EDITADO',1,'2024-12-17 01:52:14','2024-12-17 01:52:46');
...
INSERT INTO `procedimiento_abreviado` VALUES (1,'2024-01-10','Sentencia 1',1,NULL,NULL),(2,'2024-12-20','sentencia del expediente No. 14 EDITADO',1,'2024-12-10 00:55:08','2024-12-10 01:18:51');
...
INSERT INTO `prorroga_plazo_investigacion_complementaria` VALUES (1,'2024-04-19','12:00',1,NULL,NULL),(2,'2024-12-06','2024-12-06',NULL,'2024-12-06 02:46:26','2024-12-06 02:46:26'),(3,'2024-12-06','2024-12-11',NULL,'2024-12-06 02:46:44','2024-12-06 02:46:44'),(4,'2024-12-06','2024-12-11',NULL,'2024-12-06 02:46:47','2024-12-06 02:46:47'),(5,'2024-12-05','2024-12-06',NULL,'2024-12-06 02:48:24','2024-12-06 02:48:24'),(6,'2024-12-19','2024-12-26',NULL,'2024-12-06 02:48:47','2024-12-06 02:48:47'),(7,'2024-12-04','2024-12-06',NULL,'2024-12-06 02:50:15','2024-12-06 02:50:15'),(8,'2024-12-06','2024-12-13',NULL,'2024-12-07 02:22:21','2024-12-07 02:22:21');
...
INSERT INTO `roles` VALUES (1,'Administrador'),(2,'Director General'),(3,'Director Defensoria'),(4,'Director Asesoria'),(5,'Coordinador'),(6,'Defensor'),(7,'Asesor');
...
INSERT INTO `suspencion_condicional_proceso` VALUES (1,'2024-04-01','2024-04-10','Resultado SCP','Reporte cumplimiento 1',1,NULL,NULL,NULL),(2,'2024-12-07','2024-12-09','Resultado del expediente 14','Reporte de cumplimiento expediente 14',1,'2024-12-07 03:50:30','2024-12-07 03:50:30','Observaciones del expediente 14');
...
CREATE TABLE `tribunal_enjuiciamiento` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `id_expediente` bigint unsigned DEFAULT NULL,
  `id_juez` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `tribunal_enjuiciamiento` VALUES (13,1,NULL,NULL,51,19),(23,1,'2025-01-23 02:51:26','2025-01-23 02:51:26',1,33);
...
INSERT INTO `ugi` VALUES (1,'UGI 1',1,NULL,'2025-01-22 23:50:04'),(2,'UGI 2',1,'2024-04-20 02:30:13','2025-01-22 23:50:08'),(3,'UGI 2',1,'2024-04-20 02:30:22','2025-01-22 23:50:12'),(4,'UGI 3',1,'2024-04-20 02:30:30','2025-01-22 23:50:15'),(5,'UGI 4',1,'2024-04-20 02:30:38','2025-01-22 23:50:21'),(6,'UGI 5',1,'2024-04-24 01:08:00','2025-01-22 23:50:24'),(7,'UGI 6',1,'2024-04-24 05:39:22','2025-01-22 23:50:28');
...
INSERT INTO `users` VALUES (1,'Froylán','Wbario','Martínez','8341609881','admin@test.com',NULL,'$2y$10$vschSV4Rhtuux7Z.ZT6U/.5qm8baAEit9lJihePZD2xPoRidqA.pW',1,1,NULL,NULL,'2025-01-23 20:40:11','Masculino'),(20,'Julio Adrian','Adrian','Jimenez','8341609881','dd@test.com',NULL,'$2y$10$JNtuUZbjCFHaI6siPGV8Vet4UQXQ7OO3K6NtVw6CEBkt5eLDOdmTC',6,1,NULL,'2024-09-27 06:00:00','2025-01-22 22:55:36','Masculino'),(21,'Carlos','Alanis','Leal','4411239384','dd1@test.com',NULL,'$2y$10$840mv7DIFfhfN0Jodusun.TnFeA0c2JdrmSl92LeAA1MV1h.eFRS.',6,1,NULL,'2024-10-02 06:00:00','2025-01-22 23:01:02','Masculino'),(22,'Jorge Javier','Ayala','Murillo','8341609881','c1@test.com',NULL,'$2y$10$cNz6rnOj6CLalthTsDgBvu3Ftl.vU9TKbN8lxFVzGFDkAPz7RVQV2',5,1,NULL,'2024-10-02 06:00:00','2025-02-11 23:57:54','Masculino'),(33,'Juan','Muñiz','Garcia','8999442655','dd3@test.com',NULL,'$2y$10$DsE7iqhO/3txp8OElJ4LLOwE1igGosHjjGvZMci8OA7NEpnbn4NW.',5,1,NULL,'2025-02-05 06:00:00','2025-02-12 02:05:08','Masculino');
...
INSERT INTO `victima` VALUES (1,'Jose Alejandro','Segura','HDZ','8341234567','Xyz','masculino',118,28,2277,'soltero/a','1997-02-12',1,1,NULL,'2024-10-10 23:11:16'),(2,'Froylan Melquiades','Wbario','Mtz','8341609881','Eucalipto 774','masculino',118,28,2313,'soltero/a','2024-06-14',1,1,'2024-06-15 03:43:07','2025-01-23 00:41:09'),(3,'Rodrigo','Fernandez','Mendoza','8341609881','xyz','masculino',118,28,2313,'soltero/a','2024-06-18',1,1,'2024-06-18 00:11:21','2025-01-23 00:39:33'),(4,'Javier','Hernandez','Balcazar','8341609881','calle xy','femenino',118,28,2311,'soltero/a','2024-06-10',1,1,'2024-06-18 00:36:35','2025-01-23 00:40:07'),(5,'Mario','Camarillo','Marquez','8341532345','Calle feliz entre tristeza y alegria','masculino',118,28,2313,'soltero/a','1997-02-12',1,1,'2024-09-12 00:27:45','2025-01-23 00:40:28'),(6,'Antonio','Martinez','Lucio','8341112233','aaaa','masculino',118,28,2313,'soltero/a','2024-09-01',3,1,'2024-09-12 00:35:34','2025-01-23 00:40:50');
...
INSERT INTO `victimasExpediente` VALUES (29,2),(1,4),(23,4),(44,4);
...
-- Dump completed on 2025-02-20 15:19:04
