...
<!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Conclusión</h1>
                </div><!-- /.col -->
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#"> Datos Sistema Acusatorio</a></li>
                        <li class="breadcrumb-item active"> Conclusión </li>
                    </ol>
                </div>  
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                         <h3 class="card-title mt-2"> Registro de Conclusiones </h3>  
                ...
                <div class="modal-content">
                    ...
                    @submit.prevent="actualizarCheck === false ? registrarDefensor : actualizarRegistro" @keydown="form.onKeydown($event)">
                        <div class="modal-header">
                            ...
                            <h5 v-else class="modal-title" id="modalAgregar"> Actualizar Conclusión </h5>
...
export default {
    ...
    methods: {
        ...
        obtenerDatos() {
            this.items = [];
            this.axios.get('/conclusion').then( (response) => {
        ...
        async registrar() {
            ...
            await this.form.post('/conclusion').then((response) => {
                Swal.fire({
                    position: 'center',
                    icon: 'success',
        ...
        async editarRegistro() {
            await this.form.put('/conclusion/' + this.form.id, this.form).then((response) => {
        ...
        desactivar($dato) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.delete('conclusion/' + $dato.id).then((response) => {
        ...
        activar($dato) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.get('/conclusion/'+ $dato.id+"/edit").then((response) => {
