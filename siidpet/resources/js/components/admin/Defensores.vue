        ...
        <div class="row ">
            ...
            <div class="col-md-12">
                ...
                <EasyDataTable buttons-pagination :headers="datos" :items="items" :search-field="searchField"
                    :search-value="searchValue" rowsPerPageMessage="Filas por página:"
        ...
        <div class="modal fade" id="modalAgregarDefensor" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form @submit.prevent="actualizarDefensorCheck === false ? registrarDefensor : actualizarDefensor"
                        @keydown="form.onKeydown($event)">
                        <div class="modal-header">
                            <h5 v-if="!actualizarDefensorCheck" class="modal-title" id="modalAgregarDefensor"> Nuevo
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select v-model="defensor.id_coordinacion" id="rol" type="text"
                                        class="form-control " name="id_municipio">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select v-model="defensor.id_municipio" id="rol" type="text" class="form-control "
                                        name="id_municipio">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div style="color: red;" v-if="form.errors.has('name')"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" pattern="\d{12}" maxlength="12" v-model="form.phone"
                                        class="form-control" id="phone" placeholder="8341234567">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select v-model="form.gender" id="gender" type="text" class="form-control "
                                        name="gender">
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-if="!actualizarDefensorCheck" type="submit" :disabled="form.busy"
                                class="btn btn-primary" @click="registrarDefensor">
                                <i class="fas fa-save"></i> Registrar
                            </button>
                            <button v-else type="submit" :disabled="form.busy" class="btn btn-warning"
                                @click="editarDefensor">
