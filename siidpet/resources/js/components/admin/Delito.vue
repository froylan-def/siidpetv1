    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <EasyDataTable buttons-pagination :headers="datos" :items="items" rowsPerPageMessage="Filas por página:"
                    emptyMessage="No hay datos disponibles" alternating table-class-name="customize-table"
                    theme-color="var(--primary-color)" :search-field="searchField" :search-value="searchValue">
        ...
        <div class="modal fade" id="modalAgregar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form @submit.prevent="actualizarCheck === false ? registrarJuez : actualizarRegistro"
                        @keydown="form.onKeydown($event)">
                        <div class="modal-header">
                            <h5 v-if="!actualizarCheck" class="modal-title" id="modalAgregar"> Registrar nuevo delito </h5>
        ...
        async editarRegistro() {
            ...
            await this.form.put('/delito/' + this.form.id, this.form).then((response) => {
                ...
                Swal.fire({
                    position: 'center',
                    icon: 'success',
                    title: 'Delito actualizado con éxito',
                    showConfirmButton: false,
                    timer: 1500
                })
            }).catch(error => {
