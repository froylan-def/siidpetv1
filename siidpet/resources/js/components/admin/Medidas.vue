...
export default {
    ...
    methods: {
        ...
        async registrar() {
            ...
            await this.form.post('/medidacautelar').then((response) => {
                Swal.fire({
                    position: 'center',
                    icon: 'success',
        ...
        async editarRegistro() {
            await this.form.put('/medidacautelar/' + this.form.id, this.form).then((response) => {
        ...
        desactivar($usuario) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.delete('medidacautelar/' + $usuario.id).then((response) => {
