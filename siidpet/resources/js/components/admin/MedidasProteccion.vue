...
<!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Medidas de proteccion</h1>
                </div><!-- /.col -->
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#"> Datos Sistema Acusatorio</a></li>
                        <li class="breadcrumb-item active"> Medidas de proteccion </li>
                    </ol>
                </div>  
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                         <h3 class="card-title mt-2"> Registro de medidas de proteccion </h3>  
...
export default {
    ...
    methods: {
        ...
        obtenerDatos() {
            this.items = [];
            this.axios.get('/medidaproteccion').then( (response) => {
        ...
        async registrar() {
            ...
            await this.form.post('/medidaproteccion').then((response) => {
                Swal.fire({
                    position: 'center',
                    icon: 'success',
        ...
        async editarRegistro() {
            await this.form.put('/medidaproteccion/' + this.form.id, this.form).then((response) => {
        ...
        desactivar($usuario) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.delete('medidaproteccion/' + $usuario.id).then((response) => {
        ...
        activar($elemento) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.get('/medidaproteccion/'+ $elemento.id+"/edit").then((response) => {
