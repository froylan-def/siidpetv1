            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                         <h3 class="card-title mt-2"> Registro de Tribunales</h3>  
                ...
                <div class="modal-content">
                    ...
                    @submit.prevent="actualizarCheck === false ? registrarDefensor : actualizarRegistro" @keydown="form.onKeydown($event)">
                        <div class="modal-header">
                            ...
                            <h5 v-else class="modal-title" id="modalAgregar"> Actualizar Tribunal </h5>
...
export default {
    ...
    methods: {
        ...
        obtenerDatos() {
            this.items = [];
            this.axios.get('/tribunal').then( (response) => {
        ...
        async registrar() {
            ...
            await this.form.post('/Tribunal').then((response) => {
                Swal.fire({
                    position: 'center',
                    icon: 'success',
        ...
        async editarRegistro() {
            await this.form.put('/Tribunal/' + this.form.id, this.form).then((response) => {
        ...
        desactivar($dato) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.delete('Tribunal/' + $dato.id).then((response) => {
        ...
        activar($dato) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.get('/Tribunal/'+ $dato.id+"/edit").then((response) => {
