                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="form.carpeta_procesal" class="form-control" 
                                id="carpeta_procesal" rows="3" aria-describedby="carpeta_procesal" placeholder=""></textarea>
                        ...
                        <button v-else-if="!loading && esNuevo" type="button" class="btn btn-success float-right mb-1"
                            @click="guardarCarpetaProcesal"> Guardar </button>
                        <button v-else type="button" class="btn btn-warning float-right mb-1" @click="editarCarpetaProcesal">
                            Actualizar </button>
