                ...
                <div class="form-group">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <textarea v-model="form.determinacion_mp" class="form-control" 
                                id="determinacion_mp" rows="3" aria-describedby="determinacion_mp" placeholder=""></textarea>
                        ...
                        <button v-else-if="!loading && esNuevo" type="button" class="btn btn-success float-right mb-1"
                            @click="guardarDeterminacion"> Guardar </button>
                        <button v-else type="button" class="btn btn-warning float-right mb-1" @click="editarDeterminacion">
                            Actualizar </button>
