                    ...
                    <div class="row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input v-model="this.form.fecha_formulacion_imputacion"  type="date" class="form-control" id="fecha_formulacion_imputacion" name="fecha_formulacion_imputacion">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input v-model="this.form.fecha_vinculacion_proceso"  type="date" class="form-control" id="fecha_vinculacion_proceso" name="fecha_vinculacion_proceso">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea v-model="this.form.audiencia_intermedia" class="form-control" rows="4" id="audiencia_intermedia"  name="audiencia_intermedia" aria-describedby="audiencia_intermedia"></textarea>
                        ...
                        <button v-else-if="!loading && esNuevo" type="button" class="btn btn-success float-right mb-1"
                            @click="guardarFormulacionImputacion"> Guardar </button>
                        <button v-else type="button" class="btn btn-warning float-right mb-1" @click="editarFormulacionImputacion">
                            Actualizar </button>
