...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"> <b> Registro de usuarios - Provicional </b> </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="rol" type="text" class="form-control @error('IDRol') is-invalid @enderror" name="IDRol" > -->
                                
                                <select id="rol" type="text" class="form-control @error('IDRol') is-invalid @enderror" name="IDRol" >
